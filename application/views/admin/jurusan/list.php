					...
					<div class="mb-npx">
						<div class="row align-items-center">
							...
							<div class="col-sm-6 col-12 text-sm-end">
								<div class="mx-n1">
									<a href="<?php echo site_url('jurusan/pdf') ?>" class="btn d-inline-flex btn-sm btn-success mx-1">
										<span class=" pe-2">
											<i class="bi bi-printer"></i>
										</span>
										<span>Print PDF</span>
									</a>
									<a href="<?php echo site_url('jurusan/add') ?>" class="btn d-inline-flex btn-sm btn-primary mx-1">
										<span class=" pe-2">
							...
							<table id="list" class="table table-hover table-nowrap">
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-end">
											<a href="<?php echo site_url('jurusan/edit/'.$jurusan->id_jurusan) ?>" class="btn btn-sm btn-square btn-neutral"><i class="bi bi-pencil"></i></a>
											<a onclick="return confirm('Are you sure you want to delete this item?');"
											 href="<?php echo site_url('jurusan/delete/'.$jurusan->id_jurusan) ?>" class="btn btn-sm btn-square btn-neutral text-danger-hover"><i class="bi bi-trash"></i></a>
										</td>
									</tr>
                                    <?php endforeach; ?>
								</tbody>
