			...
			<main class="py-6 bg-surface-secondary">
				<div class="container-fluid">
					<div class="card mb-7">
						...
						<div class="card-body">
                        <form action="<?php echo site_url('jurusan/edit/'. $jurusan->id_jurusan) ?>" method="post" enctype="multipart/form-data">
						<!-- Note: atribut action dikosongkan, artinya action-nya akan diproses 
							...
							<div class="form-group mb-4">
								...
								<input class="form-control <?php echo form_error('nama_jurusan') ? 'is-invalid':'' ?>"
								 type="text" name="nama_jurusan" min="0" placeholder="Example: Rekayasa Perangkat Lunak" value="<?php echo $jurusan->nama_jurusan ?>" />
