			...
			<main class="py-6 bg-surface-secondary">
				<div class="container-fluid">
					<div class="card mb-7">
						...
						<div class="card-body">
                        <form action="<?php echo site_url('spp/edit/'. $spp->id_spp) ?>" method="post" enctype="multipart/form-data">
						<!-- Note: atribut action dikosongkan, artinya action-nya akan diproses 
							...
							<div class="form-group mb-4">
								...
								<input class="form-control <?php echo form_error('tahun_ajaran') ? 'is-invalid':'' ?>"
								 type="text" name="tahun_ajaran" min="0" placeholder="Example: 2016/2017" value="<?php echo $spp->tahun_ajaran ?>" />
							...
							<div class="form-group mb-4">
								...
								type="text" name="nominal" min="0" placeholder="Example: Rp200.000" value="<?php echo $spp->nominal ?>" />
								<div class="invalid-feedback">
